...
X_train,X_test,Y_train,Y_test = train_test_split(X,Y,train_size=0.2,random_state=42)  # increa
...
# Step 6 : Soft Voting Classification 
...
print("Soft voting Accuarrcy : ",acc_soft)